defmodule Utils.Box.File do
  ...
  defp commit_upload_session(%{"id" => session_id}, parts, sha_sum) do
    with client = Auth.client([{Middleware.BaseUrl, @box_data_endpoint}, {Middleware.Headers, [{"digest", "sha=#{sha_sum}"}]}, Middleware.JSON, Middleware.PathParams], retry_statuses: [202, 409, 500, 502, 503]),
